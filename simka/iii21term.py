...
III_example=[1,
             ...
             AV(-511,-511),
             AI(-511, 490)|0x200,
] + DPYSTR("              0   0,0     0,0   176K 100%  0D  JUL 26  FRIDAY  17:05")
"""
...
def convert_iii_into_tk( canvas, III_buffer, Fill ):
    ...
    (  ox,  oy ) = (    32,     32 ) # offset the displayed square inside its frame
...
def test_pattern():
    ...
    canvas.create_text(ox,oy,text=r0[:128]+"\n"+r2[:128]+"\n"+r3+"\n"+r4,font=III_Font[1],fill="gray",anchor="nw",tags="III#0")
    canvas.create_text(ox,150,text=r0[:85]+"\n"+r2[:85]+"\n"+r3[:85]+"\n"+r4[:85],font=III_Font[2],fill="gray",anchor="nw",tags="III#0")
    ...
    canvas.create_text(ox,850,text=r0[:21]+"\n"+r2[:21],font=III_Font[7],fill="gray",anchor="nw",tags="III#0")    
    canvas.create_text(ox+350,450,text="III-21",font=III_Font[7],fill="gray",anchor="nw",tags="III#0")
